...
def make_activities_file(sql_file, data_dir, file_suffix="gpx"):
    generator = Generator(sql_file)
    new_activities = generator.get_new_activities(data_dir, file_suffix=file_suffix)
    print(f"got {len(new_activities)} new activities")
